# Transcript: Escalation — low confidence / SOP gap

**Behavior:** Stage 3 — question not supported by SOP  
**Command:** `sopshield -m "Do you offer international shipping of skincare products?"`
...
### 5. Escalation status
ESCALATED — sop_gap (or low_confidence on first failure)

---

**Validation notes**
- Retrieval confidence below threshold OR no matching section
- No fabricated shipping policy
- Human handoff message from SOP
