...
```bash
python main.py --sop bloom_aesthetics_demo -m "what's your cheapest option? another clinic quoted me less"
```
...
**Customer:** what's your cheapest option? another clinic quoted me less
